...
<div class="container mt-3">
  ...
  <form action="../member" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control member-detail" id="user_password" value="********" name="user_password" readonly>
    </div>
     <div class="mb-1">
       <label for="email_id">이메일</label>
    </div>
      <div class="input-group mt-1 mb-3">
       <input type="text" class="form-control member-detail" id="email_id" value=<%=email_id%> name="email_id" readonly>@
       <input type="text" class="form-control member-detail" id="email_domain" value=<%=email_domain%> name="email_domain" readonly>
    
  </div>
  <div class="mb-3">
      <label for="available">이용가능 여부</label>
      <input type="text" class="form-control member-detail" id="available" value=<%=available%> name="user_password" readonly>
    </div>
